export const translations = {
  ru: {
    ...
    about:
      "Я Fullstack Developer с более чем 7-летним опытом. Начинал с обучения детей Scratch, Python, C#, Java и PHP. Позже выбрал разработку как свой путь и влюбился в JavaScript за его динамичное фронтенд-направление и широкие возможности. Ищу дружелюбную компанию, где смогу быть полезным, решать значимые задачи и улучшать ключевые метрики.",
    sections: {
      about: "О СЕБЕ",
    ...
    projects: [
      {
        name: "Liberandum.ai",
        url: "https://liberandum.ai/",
        role: "Лид фронтенд разработки",
      },
      {
        name: "BC Vikings: Android app",
        url: "https://play.google.com/store/apps/details?id=ru.bcvikings.app&hl=ru",
        role: "Продакт-менеджер",
      },
      {
        name: "BC Vikings: iOS app",
        url: "https://apps.apple.com/ru/app/%D0%B1%D0%BA-%D0%B2%D0%B8%D0%BA%D0%B8%D0%BD%D0%B3%D0%B8-%D1%81%D1%82%D0%B0%D0%BD%D1%8C-%D0%BB%D1%83%D1%87%D1%88%D0%B8%D0%BC/id6753190669",
        role: "Продакт-менеджер",
      },
    ...
    contactsList: [
      {
        type: "Email",
        value: "sergey.prilepko@gmail.com",
        link: "mailto:sergey.prilepko@gmail.com",
      },
      { type: "Телефон", value: "+7 999 668-33-27", link: "tel:+79996683327" },
      { type: "Telegram", value: "@TheLABL", link: "https://t.me/thelabl" },
      {
        type: "LinkedIn",
        value: "linkedin.com/in/sergey-prilepko-20a492215",
        link: "https://linkedin.com/in/sergey-prilepko-20a492215",
      },
      {
        type: "GitHub",
        value: "github.com/soulfeelings",
        link: "https://github.com/soulfeelings",
      },
    ],
    experience: [
      {
